...
public class RepositoryConfig {
    ...
    @Bean
    public IMarketDataRepository marketDataRepository(RedisTemplate<String, byte[]> redisTemplate, GatewayDsmProvider gdp) {
        return new MarketDataRepoRedisImpl(redisTemplate, gdp);
    }
